...
@theme {
  ...
  /* Spacing 기준 — Tailwind 기본(0.25rem). 1 유틸 스텝 = 4px. */
  --spacing: 0.25rem;
...
### 4.1 Spacing
`--spacing: 0.25rem`(Tailwind 기본) 스케일. **8px 그리드**를 운영 기준으로(4의 배수 보조). 1 유틸 스텝 = 4px이므로 권장 px `4 / 8 / 12 / 16 / 24 / 32 / 48 / 64` = 유틸 `1 / 2 / 3 / 4 / 6 / 8 / 12 / 16`. 컴포넌트 내부 패딩 12~16px(`p-3`~`p-4`), 섹션 간격 24~32px(`gap-6`~`gap-8`), 카드 간 gap 12~16px(`gap-3`~`gap-4`). (과거 `--spacing:1px` 였으나 컴포넌트가 모두 기본 스케일로 작성돼 0.25rem 으로 정정.)
